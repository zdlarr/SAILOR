...
class RenTrainOptions(GeoTrainOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ren_data_root', type=str, default='/home/ssd2t/dz/render_dataset6', help='# the root dir of the dataset.')
        parser.add_argument('--ren_real_root', type=str, default='/home/ssd2t/dz/render_dataset3', help='# the root dir of the real dataset.')
        ...
        parser.add_argument('--num_sampled_rays', type=int, default=2048, help='# the sampled rays num per view. such as: 1764 = 42 ** 2')
        ...
        parser.add_argument('--ray_patch_sampling', type=bool, default=False, help='# whether sampling rays in patch.')
        ...
        parser.add_argument('--adopting_upsampling', type=bool, default=False, help='# using ray upsampling to refine results.')
