...
class RenTestDataset(RenTrainDataset):
    ...
    def __init__(self, opts, phase='testing'):
        # super(RenTestDataset, self).__init__()
        self.opts     = opts
    ...
    def get_RGBD_cam_data(self, subject): # get the input N views' data.
        ...
        self.RTs_list       = self._RTs_list[:self.num_views]
    ...
    def gen_spline_camera_data_new(self, vid):
        ...
        self.tar_RT = rt_new[None].float()
         
        return {
            'target_ks':  tar_K, # [Nv, 3, 3]
            'target_rts': self.tar_RT, # [Nv, 3, 4]
            'target_view_ids': vid
        }
    ...
    def gen_spline_camera_data(self, vid):
        ...
        self.tar_RT = torch.as_tensor(tar_RT[None], dtype=torch.float32)
    ...
    def get_item(self, idx):
        ...
        neighbor_view_ids = self.get_neighbor_views_id(self.RTs_list[:4], self.tar_RT) 
