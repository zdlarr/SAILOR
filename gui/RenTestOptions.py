...
class RenTestOptions(RenTrainOptions):
    ...
    def parse(self):
        ...
        opts.support_post_fusion = True # the post-fusion operation.
        ...
        if opts.rend_full_body:
            opts.num_sampled_points_coarse = 32 # full-body sampled points.
        else:
            opts.num_sampled_points_coarse = 24 # for portrait rendering.
