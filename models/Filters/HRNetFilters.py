...
def HRNetV2_W18_small_v2_balance3(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    cfg = {
        ...
        "STAGE4":{
            ...
            "NUM_BRANCHES": 4,
            "NUM_BLOCKS": [2, 2, 2, 2],
            "NUM_CHANNELS": [16, 60, 80, 120], # add weights. [80, 160, 240, 360]； [1, 8, 16, 60, 80, 120], 16, 60, 80, 120
            "BLOCK": "Basic",
            "FUSE_METHOD": "SUM",
        },
...
def HRNetV2_W18_small_v2_balance2(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    cfg = {
        ...
        "STAGE4":{
            ...
            "NUM_BRANCHES": 4,
            "NUM_BLOCKS": [2, 2, 2, 2],
            "NUM_CHANNELS": [64, 100, 160, 240], # add weights. [80, 160, 240, 360]； [1, 8, 16, 60, 80, 120]
            "BLOCK": "Basic",
            "FUSE_METHOD": "SUM",
        },
        "last_layer": last_layer
