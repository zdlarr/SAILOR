...
def HRNetV2_W18_small_v2(opts, n_input_dim=4, n_output_dim=64, pretrained=False, last_layer=True):
    cfg = {
        "STAGE1":{
            "NUM_MODULES": 1,
            "NUM_BRANCHES": 1,
    ...
    #             )
    model = HRNet(opts, cfg, output_channel_num=n_output_dim, inplanes=18, n_input_channel=n_input_dim)
    model.init_weights()
    return model


def HRNetV2_W18_small_v2_renew(opts, n_input_dim=4, n_output_dim=64, pretrained=False, last_layer=True):
    cfg = {
        "STAGE1":{
            "NUM_MODULES": 1,
            "NUM_BRANCHES": 1,
    ...
    model = HRNet(opts, cfg, output_channel_num=n_output_dim, inplanes=64, n_input_channel=n_input_dim)
    model.init_weights()
    return model
...
def HRNetV2_W18_small_v2_balance3(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    ...
    model = HRNet(opts, cfg, output_channel_num=128, inplanes=12, n_input_channel=n_input_dim)
    return model
...
def HRNetV2_W18_small_v2_light_depth(opts,  n_input_dim=4, n_output_dim=32, pretrained=False, last_layer=False):
    ...
    model = HRNet(opts, cfg, output_channel_num=n_output_dim, inplanes=12, n_input_channel=n_input_dim)
    return model
...
def HRNetV2_W18_small_v2_balance2(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    ...
    model = HRNet(opts, cfg, output_channel_num=128, inplanes=10, n_input_channel=n_input_dim)
    return model
...
if __name__ == '__main__':
    ...
    backbone = HRNetV2_W18_small_v2(opts, n_input_dim=4, n_output_dim=64).to(device)
    # print(backbone)
