...
def HRNetV2_W18_small_v2_balance5(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    cfg = {
        "STAGE1":{
            "NUM_MODULES": 1,
            "NUM_BRANCHES": 1,
...
def HRNetV2_W18_small_v2_balance4(opts,  n_input_dim=4, pretrained=False, last_layer=False):
    cfg = {
        "STAGE1":{
            "NUM_MODULES": 1,
            "NUM_BRANCHES": 1,
